...
void editorSelectSyntaxHighlight()
{
    ...
    performance_file = fopen("Performance_parallel.txt", "a");
...
int main(int argc, char *argv[])
{
    ...
    fclose(fopen("Performance_parallel.txt", "w"));
